...
**这是一个3年之约，3年里的每1天早上六点半我们都会学习1个技术点1道面试题。程序员是一个需要终身学习的职业，让我们持续保持对技术的关注度。**

**在下方我的公众号会坚持在每天早上六点半准时推送。**

- ### 第一周

  - [三年之约第一周（Java在开发中常见的异常是什么？、那JDK和CGLIB动态代理哪个更快？）](https://github.com/hdgaadd/JavaProGuide/blob/master/技术成长/第一周/3年之约.md)
