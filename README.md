# Java学习/进阶/面试指南（JavaProGuide）

> 作为一份《Java学习/进阶/面试指南》，该指南涵盖了在大厂工作的Javaer都不会不懂的核心知识、面试重点。相信一定对你学习Java、成为更好的Java选手有所帮助，祝大家在Java成长路上不迷茫。
...
- ### 基础
  - [掌握List集合最常见的ArrayList、Vector、LinkedList，ArrayList是考的最多的](https://github.com/hdgaadd/JavaProGuide/blob/master/Java专栏/四大集合之List/面试官没想到一个ArrayList，我都能跟他扯半小时.md)
  - [掌握接口和抽象类的区别，笔试题经常出现：静态分派、访问修饰符](https://github.com/hdgaadd/JavaProGuide/blob/master/Java专栏/接口和多态/接口和多态.md)
  - [三元运算符、自动类型提升、byte溢出、i++自增问题，笔试题出现频率高](https://github.com/hdgaadd/JavaProGuide/blob/master/Java专栏/数据类型和程序运算/数据类型和程序运算.md)
  - [掌握HashMap底层原理、HashMap为什么线程不安全](https://github.com/hdgaadd/JavaProGuide/blob/master/Java专栏/四大集合之HashMap/掌握HashMap底层原理、HashMap为什么线程不安全.md)
